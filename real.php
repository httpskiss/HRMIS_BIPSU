...
<body class="bg-gray-100">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-red-500 text-sm">-3% from yesterday</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold">756</h3>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">June payroll completed for 1,254 employees</p>
    ...
    <script>
        ...
        const departmentChart = new Chart(departmentCtx, {
            type: 'bar',
            data: {
                labels: ['Computer Science', 'Mathematics', 'Physics', 'Chemistry', 'Biology', 'Administration', 'HR', 'Finance'],
                datasets: [{
                    label: 'Employees',
                    data: [185, 132, 98, 76, 65, 342, 56, 45],
                    backgroundColor: [
                        'rgba(54, 162, 235, 0.6)',
                        'rgba(255, 99, 132, 0.6)',
                        'rgba(255, 206, 86, 0.6)',
